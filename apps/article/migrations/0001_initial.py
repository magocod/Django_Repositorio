    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collections', models.ManyToManyField(related_name='article_collections', to='collection.Collection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(default=django.utils.timezone.now)),
                ('article', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='article_specification', to='article.Article')),
            ],
        ),
    ]
